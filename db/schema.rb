...
ActiveRecord::Schema.define(version: 20170730213412) do
  ...
  create_table "products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer "image_file_size"
    t.datetime "image_updated_at"
    t.integer "sort_top", default: 0
  end

  create_table "rootadmins", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
